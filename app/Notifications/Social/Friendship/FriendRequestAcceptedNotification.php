...
class FriendRequestAcceptedNotification extends Notification implements ShouldBroadcast, ShouldQueue
{
    use Queueable;
    ...
    protected function getNotificationData(): array
    {
        ...
        return [
            'message' => "Ваш запит у друзі до <a href=\"{$userUrl}\">{$this->receiver->username}</a> було прийнято!",
